package com.login.huntvision.view.actionbar;
...
/*
		...
		/*
		 * TypedArray a =
		 * context.obtainStyledAttributes(attrs,R.styleable.ActionBar);
		 * CharSequence title = a.getString(R.styleable.ActionBar_title); if
		 * (title != null) { setTitle(title); } a.recycle();
		 */
    }
