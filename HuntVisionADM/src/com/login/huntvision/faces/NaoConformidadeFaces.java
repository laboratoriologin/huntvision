...
@SessionScoped
@ManagedBean(name = "naoConformidadeFaces")
public class NaoConformidadeFaces extends CrudFaces<Vistoria> {
	...
	public String gerarRelatorioNaoConformidade() {
		...
		List<VistoriaResposta> vistoriasRespostas = resposta.findAllByVistoriaNaoConformidade();

		LocalRespostas localResposta = null;

		this.respostas = new ArrayList<NaoConformidadeFaces.LocalRespostas>();
	...
	public class LocalRespostas {
		...
		private NaoConformidadeFaces getOuterType() {
			return NaoConformidadeFaces.this;
		}
